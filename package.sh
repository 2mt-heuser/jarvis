...
function chelp()
{
	...
	printf "\n"
	printf "OPTIONS:\n"
	printf "  -h  ${White}help${NC}       : Show this message\n"
	printf "  -s  ${White}silent${NC}     : No output except on errors\n"
	printf "  -y  ${White}confirm${NC}    : Don't ask for confirmation\n"
	printf "  -v  ${White}version${NC}    : Version/Tag to build\n"
	printf "\n"
}
...
then
printf "\n"
printf "*********** ${BCyan}2mt.ModPacker (jarvis)${NC} ***********\n"
printf "\n"
fi
